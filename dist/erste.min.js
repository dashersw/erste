...
h.dispose=function(){this.m.dispose();this.el&&this.el.removeEventListener("scroll",this.F);document.body.removeEventListener("touchend",this.R);L.prototype.dispose.call(this)};l.Object.defineProperties(X.prototype,{i:{configurable:!0,enumerable:!0,get:function(){return{Y:"pull-to-refresh-arrow",ja:".spinner"}}}});X.prototype.threshold=135;X.prototype.height=96;X.prototype.arrowOffset=0;function Y(){J.call(this,{v:Infinity});this.o=this.c.l}v(Y,J);Y.prototype.reset=function(){this.o=this.c.l};Y.prototype.fa=function(){this.o!=this.c.LOADING&&(this.o=this.c.M)};Y.prototype.V=function(){return this.o==this.c.M};Y.prototype.load=function(){this.V()&&(this.o=this.c.LOADING,this.D(this.EventType.SHOULD_LOAD))};
