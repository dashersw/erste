...
*/
var z = {}, A = Array.isArray ? Array.isArray : function(a) {
...
function F(a, b, c, d) {
  ...
  if ("*" === q || "**" === q || c[q]) {
    ...
    if ("**" === q) {
      (q = d + 1 === p || d + 2 === p && "*" === y) && c._listeners && (e = e.concat(F(a, b, c, p)));
      for (f in c) {
        "_listeners" !== f && c.hasOwnProperty(f) && ("*" === f || "**" === f ? (c[f]._listeners && !q && (e = e.concat(F(a, b, c[f], p))), e = e.concat(F(a, b, c[f], d))) : e = f === y ? e.concat(F(a, b, c[f], d + 2)) : e.concat(F(a, b, c[f], d)));
      }
      return e;
    }
  ...
  if (c = c["**"]) {
    if (d < p) {
      for (f in c._listeners && F(a, b, c, p), c) {
        "_listeners" !== f && c.hasOwnProperty(f) && (f === y ? F(a, b, c[f], d + 2) : f === q ? F(a, b, c[f], d + 1) : (p = {}, p[f] = c[f], F(a, b, {"**":p}, d + 1)));
      }
    } else {
...
E.prototype.off = function(a, b) {
  ...
  for (var f = 0;f < e.length;f++) {
    ...
    d = h._listeners;
    if (A(d)) {
      for (var p = -1, q = 0, y = d.length;q < y;q++) {
...
E.prototype.listeners = function(a) {
  ...
  A(this._events[a]) || (this._events[a] = [this._events[a]]);
...
var G = {};
function H() {
  z.default.call(this, {maxListeners:Infinity});
  this.id_ = u.default.getUid();
  this.element_ = null;
  u.default.setComponent(this);
}
g.inherits(H, z.default);
...
H.prototype.render = function(a, b) {
  a && (this.element_ = this.element_ || u.default.createElement(this.toString().trim()), this.element_.id = this.id, a.insertBefore(this.element_, a.children[b ? b : a.children.length - 1] || null));
};
...
g.global.Object.defineProperties(H.prototype, {id:{configurable:!0, enumerable:!0, get:function() {
  ...
  var a = this.element_;
  a || (a = this.element_ = document.getElementById(this.id) || u.default.createElement(this.toString().trim()));
  return a;
}}});
G.default = H;
var I = {};
...
k.exportProperty(J.prototype, "activate", J.prototype.activate);
...
g.global.Object.defineProperties(J.prototype, {template_content:{configurable:!0, enumerable:!0, get:function() {
  return "";
}}});
J.prototype.index = 0;
...
M.prototype.push = function() {
  ...
  }), this.currentView = a, a.activate && a.activate(), setTimeout(function() {
    return b.dispose();
  ...
  if (this.firstX) {
    ...
    window.requestAnimationFrame(function() {
      ...
      if (f < I.default.WIDTH / 2) {
        var a = "0", q = "-30%", y = function() {
          d.el.style.transitionDuration = "0s";
          d.el.style.transform = "translate3d(-100%,-100%,0)";
          d.el.removeEventListener("transitionend", y);
        };
        d.el.addEventListener("transitionend", y);
      } else {
        b.currentView = b.getLastViewInHistory(), c.pop(), d.activate && d.activate(), setTimeout(function() {
          e.dispose();
        }, 1000);
      }
...
M.prototype.toggleSidebar_ = function(a) {
  var b = this, c = this.currentView, d = document.querySelector("sidebar-view");
  setTimeout(function() {
    c.el.style.transitionDuration = "0.35s";
...
M.prototype.openSidebarTouchMove_ = function(a) {
  if (!u.default.gestureHandler.canTap) {
    ...
    4 == this.lastTouches.length && this.lastTouches.shift();
    a.preventDefault();
    var c = document.querySelector("sidebar-view"), d = this.currentView, e = b - this.firstX;
...
g.inherits(O, G.default);
O.prototype.onSidebarItemTap = function(a) {
  if (a = a.targetEl && a.targetEl.getAttribute && a.targetEl.getAttribute("data-view")) {
    this.emit(O.EventType.SWITCH_VIEW, {view:a}), this.vm && this.vm.toggleSidebar();
  }
};
k.exportProperty(O.prototype, "onSidebarItemTap", O.prototype.onSidebarItemTap);
O.prototype.template = function() {
  return '\n<sidebar-view class="view">\n    <sidebar-items>' + this.template_items + "</sidebar-items>\n</sidebar-view>\n";
};
k.exportProperty(O.prototype, "template", O.prototype.template);
g.global.Object.defineProperties(O.prototype, {template_items:{configurable:!0, enumerable:!0, get:function() {
  return "";
}}, mappings:{configurable:!0, enumerable:!0, get:function() {
  return {ITEM:"sidebar-item"};
}}, events:{configurable:!0, enumerable:!0, get:function() {
  var a = {};
  return {tap:(a[this.mappings.ITEM] = this.onSidebarItemTap.bind(this), a)};
}}});
g.global.Object.defineProperties(O, {EventType:{configurable:!0, enumerable:!0, get:function() {
...
g.inherits(Q, I.default);
Q.WIDTH = I.default.WIDTH;
k.exportSymbol("TabBar$$module$$src$components$tabbar$tabbar.WIDTH", Q.WIDTH);
Q.prototype.onAfterRender = function() {
  this.vm = new L.default(this.el);
};
k.exportProperty(Q.prototype, "onAfterRender", Q.prototype.onAfterRender);
Q.prototype.onItemTap = function(a) {
...
k.exportProperty(Q.prototype, "onItemTap", Q.prototype.onItemTap);
Q.prototype.activateItem = function(a) {
  if (-1 != a) {
...
k.exportProperty(Q.prototype, "activateItem", Q.prototype.activateItem);
Q.prototype.activateItemByName = function(a) {
...
k.exportProperty(Q.prototype, "activateItemByName", Q.prototype.activateItemByName);
Q.prototype.deactivateActiveItem = function() {
  var a = this.$(this.mappings.ACTIVE);
  a && a.classList.remove("active");
};
k.exportProperty(Q.prototype, "deactivateActiveItem", Q.prototype.deactivateActiveItem);
g.global.Object.defineProperties(Q.prototype, {template_content:{configurable:!0, enumerable:!0, get:function() {
  return "\n<tab-bar>\n    <tab-items>\n        " + this.template_items + "\n    </tab-items>\n</tab-bar>\n";
}}, template_items:{configurable:!0, enumerable:!0, get:function() {
  return "";
}}, mappings:{configurable:!0, enumerable:!0, get:function() {
...
g.inherits(S, G.default);
S.prototype.onBackButtonTap = function() {
  this.vm.push();
};
S.prototype.onMenuButtonTap = function() {
...
S.prototype.template = function() {
  var a = "", b = "";
  this.hasBackButton && (a = '<back-button style="display: block"><i class="icon-back"></i></back-button>');
  this.hasMenuButton && (b = '<menu-button><i class="icon-navigation"></i></menu-button>');
  return '\n<nav-bar id="' + this.id + '">' + a + b + (this.config.title || "") + "</nav-bar>\n";
};
g.global.Object.defineProperties(S.prototype, {mappings:{configurable:!0, enumerable:!0, get:function() {
  return {BACK_BUTTON:"back-button", MENU_BUTTON:"menu-button"};
}}, events:{configurable:!0, enumerable:!0, get:function() {
  var a = {};
  return {tap:(a[this.mappings.BACK_BUTTON] = this.onBackButtonTap.bind(this), a[this.mappings.MENU_BUTTON] = this.onMenuButtonTap.bind(this), a)};
}}});
R.default = S;
var T = {}, U = {en:{__name:"English"}}, V = U.en;
function W(a, b) {
  U[a] = b;
}
k.exportSymbol("setDictionary$$module$$src$lib$locale", W);
function X(a) {
  V = U[a];
}
k.exportSymbol("setLanguage$$module$$src$lib$locale", X);
function Y(a, b) {
  for (var c = [], d = 1;d < arguments.length;++d) {
    c[d - 1] = arguments[d];
  }
  return (V[a] || a).replace(/{(\d+)}/g, function(a, b) {
    return "undefined" != typeof c[b] ? c[b] : a;
  });
}
k.exportSymbol("getLocalizedString$$module$$src$lib$locale", Y);
T.default = {setDictionary:W, setLanguage:X, getLocalizedString:Y, __:Y};
window.erste = {Component:G.default, ViewManager:L.default, View:I.default, Sidebar:N.default, TabBar:P.default, NavBar:R.default, locale:T.default};
