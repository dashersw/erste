...
try{c()}catch(m){this.j(m)}}}this.a=null};b.prototype.j=function(a){this.f(function(){throw a;})};a.prototype.f=function(){function a(a){return function(e){c||(c=!0,a.call(b,e))}}var b=this,c=!1;return{resolve:a(this.ca),reject:a(this.g)}};a.prototype.ca=function(b){if(b===this)this.g(new TypeError("A Promise cannot resolve to itself"));else if(b instanceof a)this.Ca(b);else{var c;a:switch(typeof b){case "object":c=null!=b;break a;case "function":c=!0;break a;default:c=!1}c?this.U(b):this.s(b)}};
a.prototype.U=function(a){var b=void 0;try{b=a.then}catch(g){this.g(g);return}"function"==typeof b?this.Ka(b,a):this.s(a)};a.prototype.g=function(a){this.G(2,a)};a.prototype.s=function(a){this.G(1,a)};a.prototype.G=function(a,b){if(0!=this.o)throw Error("Cannot settle("+a+", "+b|"): Promise already settled in state"+this.o);this.o=a;this.j=b;this.H()};a.prototype.H=function(){if(this.a){for(var a=this.a,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.a=null}};var d=new b;a.prototype.Ca=function(a){var b=
this.f();a.b(b.resolve,b.reject)};a.prototype.Ka=function(a,b){var c=this.f();try{a.call(b,c.resolve,c.reject)}catch(m){c.reject(m)}};a.prototype.then=function(b,c){function d(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(na){f(na)}}:b}var e,f,u=new a(function(a,b){e=a;f=b});this.b(d(b,e),d(c,f));return u};a.prototype.catch=function(a){return this.then(void 0,a)};a.prototype.b=function(a,b){function c(){switch(e.o){case 1:a(e.j);break;case 2:b(e.j);break;default:throw Error("Unexpected state: "+
...
document.body?ka():document.addEventListener("DOMContentLoaded",ka);var ma=function(){var a=document.createElement("div");return function(b){a.innerHTML=b.trim();return a.removeChild(a.firstChild)}}();function oa(a){var b=a,c=[],d,e;if(e=b.Ja)return e.split(",").forEach(function(a){return c.push(G[a])}),c;e=[];do if(d=G[b.id])c.push(d),e.push(b.id);while(b=b.parentNode);a.Ja=e.join(",");return c}
function la(a){a.w=a.target;var b=oa(a.target),c=!1;do{if(c)break;a.targetEl=a.w;for(var c=b,d=a,e=!1,f=0;f<c.length;f++){var g=c[f],m=g&&g.events&&g.events[d.type];if(m){var p=Object.keys(m);if(!1===pa(g,d,m,p)){e=!0;break}}}c=e}while((a.w=a.w.parentNode)&&a.w!=document.body)}function pa(a,b,c,d){var e=!0;d.forEach(function(d){b.w.matches&&b.w.matches(d)&&(e=c[d].call(a,b,G[b.w.id]))});return e}var qa={get ma(){return ia}};/*
 EventEmitter2
...
J.prototype.La=function(a){void 0!==a&&(this.a||I.call(this),this.a.v=a,this.g||(this.g={}),this.g.v=a)};J.prototype.setMaxListeners=J.prototype.La;J.prototype.event="";J.prototype.event=J.prototype.event;J.prototype.once=function(a,b){this.oa(a,1,b);return this};J.prototype.once=J.prototype.once;J.prototype.oa=function(a,b,c){function d(){--b||e.da(a,d);c.apply(this,arguments)}var e=this;if("function"!==typeof c)throw Error("many only accepts instances of Function");d.T=c;this.P(a,d);return e};
J.prototype.many=J.prototype.oa;
...
J.prototype.qa=function(a){if(!arguments.length)return!this.a||I.call(this),this;if(this.A)for(var b=K.call(this,null,"string"===typeof a?a.split(this.C):a&&a.slice(),this.f,0),c=0;c<b.length;c++)b[c].h=null;else this.a&&(this.a[a]=null);return this};J.prototype.removeAllListeners=J.prototype.qa;
J.prototype.na=function(a){if(this.A){var b=[];K.call(this,b,"string"===typeof a?a.split(this.C):a.slice(),this.f,0);return b}this.a||I.call(this);this.a[a]||(this.a[a]=[]);ra(this.a[a])||(this.a[a]=[this.a[a]]);return this.a[a]};J.prototype.listeners=J.prototype.na;J.prototype.Aa=function(a){return this.na(a).length};J.prototype.listenerCount=J.prototype.Aa;J.prototype.Ba=function(){return this.b?this.b:[]};J.prototype.listenersAny=J.prototype.Ba;function L(){J.call(this,{v:Infinity});this.za=(ha++).toString(36);this.W=this.B=null;this.K=!1;G[this.id]=this;this.rendered||(H[this.id]=this)}v(L,J);L.prototype.ra=function(){return'$1 id="'+this.id+'"'};L.prototype.toString=function(){if(this.W)return this.W;var a=/^(<[^>]+)/,b=this.template().trim();if(!b.match(a))throw Error("Template needs to start with a valid tag.");return this.W=b=b.replace(/\s+/," ").replace(a,this.ra())};L.prototype.toString=L.prototype.toString;
...
L.prototype.template=L.prototype.template;L.prototype.dispose=function(){delete G[this.id];delete H[this.id];this.qa();this.B&&this.B.parentNode&&this.B.parentNode.removeChild(this.B);this.B=null};L.prototype.dispose=L.prototype.dispose;
l.Object.defineProperties(L.prototype,{id:{configurable:!0,enumerable:!0,get:function(){return this.za}},el:{configurable:!0,enumerable:!0,get:function(){var a=this.B;a||(a=this.B=document.getElementById(this.id)||ma(this.toString()));return a}},rendered:{configurable:!0,enumerable:!0,get:function(){if(!this.K){var a=document.getElementById(this.id);a&&(this.B=a,this.K=!0,this.onAfterRender())}return this.K}}});function M(){L.call(this);this.rendered=!1}var N;v(M,L);h=M.prototype;h.render=function(a,b){a=void 0===a?document.body:a;this.index=void 0===b?0:b;L.prototype.render.call(this,a)};h.onAfterRender=function(){L.prototype.onAfterRender.call(this);this.el.style.zIndex=this.index;this.el.style.transform="translate3d(0, 0, "+this.index+"px)"};h.onActivation=function(){};h.template=function(){return"\n<view></view>\n"};h.ra=function(){return'$1 id="'+this.id+'" view'};
l.Object.defineProperties(M,{WIDTH:{configurable:!0,enumerable:!0,get:function(){if(N)return N;var a=window.getComputedStyle(document.body,null);return N=parseInt(a&&a.width||0,10)}}});M.prototype.index=0;M.prototype.supportsBackGesture=!1;M.prototype.hasSidebar=!1;function O(a){this.g=[];this.f=[];this.a=O.c.l;this.j=this.U=this.b=this.s=null;this.H=!1;a&&(this.ca=a)}function P(a){var b;a.H=!0;b=b||a.ca;if(b instanceof M)if(b.rendered)a.s=b.el;else throw Error("View Manager's root is not rendered yet");else a.s=b||document.body;a.s&&(a.s.addEventListener("touchmove",a.Ia.bind(a),!1),a.s.addEventListener("touchend",a.Ha.bind(a),!1))}h=O.prototype;
...
h.Ia=function(a){var b=a.changedTouches&&a.changedTouches[0].clientX||0;clearTimeout(this.U);if(this.a==O.c.l||this.a==O.c.N)this.j=b;this.a==O.c.l&&(this.f=[],this.a=O.c.la);this.a==O.c.la&&(50>=b?this.g.length&&this.b&&this.b.supportsBackGesture&&(this.a=O.c.aa):this.b&&this.b.hasSidebar&&(this.f.push(this.j-b),4==this.f.length&&this.f.shift(),40<this.f[2]-this.f[0]&&(this.a=O.c.S)));this.a==O.c.N&&(this.a=O.c.Z);switch(this.a){case O.c.aa:ua(this,a);break;case O.c.Z:va(this,a);break;case O.c.S:wa(this,
a)}};h.Ha=function(a){switch(this.a){case O.c.aa:xa(this,a);break;case O.c.S:a=!0;3>this.f[2]-this.f[0]&&(a=!1);Q(this,a);break;case O.c.Z:a=!0;-3>this.f[2]-this.f[0]&&(a=!1);Q(this,a);break;case O.c.N:if(qa.ma.J)break;Q(this,!1);break;default:this.a=O.c.l}};
...
function wa(a,b){if(!qa.ma.J){var c=b.changedTouches&&b.changedTouches[0].clientX||0;a.f.push(a.j-c);4==a.f.length&&a.f.shift();b.preventDefault();var d=document.querySelector("sidebar"),e=a.b,f=c-a.j;0<=f||(a.a=O.c.S,window.requestAnimationFrame(function(){d.style.transform="translate3d(0, 0, "+(e.index-1)+"px)";d.style.transitionDuration="0s";e.el.style.transitionDuration="0s";e.el.style.transform="translate3d("+f+"px, 0, "+e.index+"px)"}))}}
l.Object.defineProperties(O,{c:{configurable:!0,enumerable:!0,get:function(){return{l:"default",la:"started",Z:"closingSidebar",S:"openingSidebar",N:"sidebarOpen",aa:"going"}}}});O.prototype.G=1;window.requestAnimationFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)};var R={en:{__name:"English"}},ya=R.en;function za(a,b){R[a]=b}D("setDictionary$$module$$src$lib$locale",za);function Aa(a){ya=R[a]}D("setLanguage$$module$$src$lib$locale",Aa);function S(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];return(ya[a]||a).replace(/{(\d+)}/g,function(a,b){return"undefined"!=typeof c[b]?c[b]:a})}D("getLocalizedString$$module$$src$lib$locale",S);var Ba={setDictionary:za,setLanguage:Aa,getLocalizedString:S,__:S};function T(){L.call(this);this.vm=null}v(T,L);T.prototype.onSidebarItemTap=function(a){if(a=a.w&&a.w.getAttribute&&a.w.getAttribute("data-view"))this.D(T.EventType.ua,{view:a}),this.vm&&this.vm.toggleSidebar()};T.prototype.template=function(){return"\n<sidebar>\n    <sidebar-items>"+this.template_items()+"</sidebar-items>\n</sidebar>\n"};T.prototype.template_items=function(){return""};
l.Object.defineProperties(T.prototype,{i:{configurable:!0,enumerable:!0,get:function(){return{L:"sidebar-item"}}},events:{configurable:!0,enumerable:!0,get:function(){var a={};return{tap:(a[this.i.L]=this.onSidebarItemTap,a)}}}});l.Object.defineProperties(T,{EventType:{configurable:!0,enumerable:!0,get:function(){return{ua:"switchView"}}}});function U(){M.call(this);this.vm=null;this.views=[]}v(U,M);h=U.prototype;h.onAfterRender=function(){M.prototype.onAfterRender.call(this);var a=this.$(this.i.va);if(!a)throw Error("TabView template must have <views>");this.vm=new O(a);this.activateItem(0)};h.onItemTap=function(a){var b=this.$(this.i.ha);b&&b==a.w||(b=this.$(this.i.ia),this.activateItem([].indexOf.call(b&&b.children,a.w)))};
h.activateItem=function(a){if(-1!=a){this.deactivateActiveItem();var b=this.$$(this.i.L)[a];b&&b.classList.add("active");this.views&&this.views[a]&&this.vm.setCurrentView(this.views[a],!0)}};h.activateItemByName=function(a){if(a=this.$(this.i.L+"[data-view="+a+"]")){var b=this.$(this.i.ia);this.activateItem([].indexOf.call(b&&b.children,a))}};h.deactivateActiveItem=function(){var a=this.$(this.i.ha);a&&a.classList.remove("active")};
h.template=function(){return"\n<tab-view>\n    "+this.template_views()+"\n    <tab-bar>\n        <tab-items>\n            "+this.template_items()+"\n        </tab-items>\n    </tab-bar>\n</tab-view>\n"};h.template_views=function(){return"<views>"+this.views.join("")+"</views>"};h.template_items=function(){return""};
l.Object.defineProperties(U.prototype,{i:{configurable:!0,enumerable:!0,get:function(){return{L:"tab-item",ia:"tab-items",ha:".active",va:"views"}}},events:{configurable:!0,enumerable:!0,get:function(){var a={};return{touchend:(a[this.i.L]=this.onItemTap.bind(this),a)}}}});function V(a){a=a?a:{hasBackButton:!1,hasMenuButton:!1,title:""};L.call(this);this.vm=null;this.xa=a}v(V,L);V.prototype.onBackButtonTap=function(){this.vm&&this.vm.push()};V.prototype.onMenuButtonTap=function(){this.vm&&this.vm.toggleSidebar()};V.prototype.template=function(){var a=this.xa,b="",c="";a.hasBackButton&&(b="<back-button></back-button>");a.hasMenuButton&&(c="<menu-button></menu-button>");return"\n<nav-bar>"+b+c+a.title+"</nav-bar>\n"};
l.Object.defineProperties(V.prototype,{i:{configurable:!0,enumerable:!0,get:function(){return{sa:"back-button",ta:"menu-button"}}},events:{configurable:!0,enumerable:!0,get:function(){var a={};return{tap:(a[this.i.sa]=this.onBackButtonTap,a[this.i.ta]=this.onMenuButtonTap,a)}}}});function W(){J.call(this,{v:Infinity});this.reset();this.o=this.c.l}v(W,J);W.prototype.reset=function(){this.o=this.c.l};W.prototype.fa=function(){this.o!=this.c.ja&&(this.o=this.c.M)};W.prototype.V=function(){return this.o==this.c.M};W.prototype.refresh=function(){this.V()&&(this.o=this.c.ja,this.D(this.EventType.SHOULD_REFRESH))};
l.Object.defineProperties(W.prototype,{c:{configurable:!0,enumerable:!0,get:function(){return{l:"default",M:"shouldCheck",ja:"refreshing"}}},EventType:{configurable:!0,enumerable:!0,get:function(){return{SHOULD_REFRESH:"refresh"}}}});function X(a){L.call(this);this.m=new W;this.EventType=this.m.EventType;this.R=this.F=this.O=this.u=null;a&&this.register(a);this.ba()}v(X,L);h=X.prototype;h.ba=function(){this.m.P(this.m.EventType.SHOULD_REFRESH,this.Ga.bind(this))};h.Ga=function(){var a=this,b=this.$(this.i.ka),c=this.$(this.i.Y);window.requestAnimationFrame(function(){a.O.style.transform="translateY("+a.height+"px)";a.O.style.transition="800ms cubic-bezier(.41,1,.1,1)";b&&(b.style.opacity=1);c&&(c.style.opacity=0);a.D(a.m.EventType.SHOULD_REFRESH)})};
h.onAfterRender=function(){L.prototype.onAfterRender.call(this);this.u||this.register(this.el.parentElement)};h.reset=function(){this.u&&(this.O.style.transform="translateY(0)",this.O.style.transition="300ms ease-out");var a=this.$(this.i.ka),b=this.$(this.i.Y);a&&(a.style.opacity=0);setTimeout(function(){b&&(b.style.opacity=1)},500);this.m.reset()};
h.register=function(a,b){a&&(this.F&&this.u.removeEventListener("scroll",this.F),this.R&&document.body.removeEventListener("touchend",this.R),this.u=a,this.O=b?b:a,this.reset(),this.F=this.ea.bind(this),this.R=this.Ea.bind(this),this.u.addEventListener("scroll",this.F),document.body.addEventListener("touchend",this.R))};
h.ea=function(a){this.m.fa();var b=0,c=-(a.target&&a.target.scrollTop||0);a=this.arrowOffset+Math.pow(c,.75);var d=this.threshold-60;c>=d&&(b=Math.min(180,3*(c-d)));if(c=this.$(this.i.Y))c.style.transform="translateY("+a+"px) rotate("+b+"deg)"};h.Ea=function(){this.u.scrollTop<-this.threshold&&this.m.refresh()};h.template=function(){return"\n<pull-to-refresh>\n    <pull-to-refresh-arrow></pull-to-refresh-arrow>\n    <pull-to-refresh-spinner></pull-to-refresh-spinner>\n</pull-to-refresh>\n"};
h.dispose=function(){this.m.dispose();this.el&&this.el.removeEventListener("scroll",this.F);document.body.removeEventListener("touchend",this.R);L.prototype.dispose.call(this)};l.Object.defineProperties(X.prototype,{i:{configurable:!0,enumerable:!0,get:function(){return{Y:"pull-to-refresh-arrow",ka:"pull-to-refresh-spinner"}}}});X.prototype.threshold=135;X.prototype.height=96;X.prototype.arrowOffset=0;function Y(){J.call(this,{v:Infinity});this.o=this.c.l}v(Y,J);Y.prototype.reset=function(){this.o=this.c.l};Y.prototype.fa=function(){this.o!=this.c.LOADING&&(this.o=this.c.M)};Y.prototype.V=function(){return this.o==this.c.M};Y.prototype.load=function(){this.V()&&(this.o=this.c.LOADING,this.D(this.EventType.SHOULD_LOAD))};
